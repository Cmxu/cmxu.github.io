...
\textbf{SEVerA: Verified Synthesis of Self-Evolving Agents}\\
Debangshu Banerjee*, \underline{Changming Xu}*, Gagandeep Singh. In Submission\\[-8pt]

\textbf{Enforcing Temporal Constraints for LLM Agents}\\
Adharsh Kamath, Sishen Zhang, \underline{Changming Xu}, Shubham Ugare, Gagandeep Singh, Sasa Misailovic. In Submission\\[-8pt]
